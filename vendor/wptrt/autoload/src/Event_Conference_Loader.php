...
class Event_Conference_Loader {
	 ...
	 * @return void
	 */
	public function event_conference_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function event_conference_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function event_conference_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function event_conference_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->event_conference_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function event_conference_load( $class ) {
